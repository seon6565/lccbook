                                ...
                                <div class="card">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="faq_content" id="faq_content" placeholder="질문을 입력해주세요" maxlength="100">
                                        </div>
                                        <div class="mb-3">
                                            <label for="answer_content" class="form-label">A. 답변</label>
                                            <textarea class="form-control" id="answer_content" name="answer_content" rows="5" placeholder="답변을 입력해주세요." maxlength="400"   ></textarea>
                                        </div>
