    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <svg class="bd-placeholder-img" width="100%" height="450px" xmlns="" aria-hidden="true"
            ...
            <div class="carousel-item">
                <svg class="bd-placeholder-img" width="100%" height="450px" xmlns="http://www.w3.org/2000/svg"
            ...
            <div id="notice" class="box">
                ...
                <c:forEach items="${noticeDTOList}" var="list">
                    ...
                    <table class="table">
                        <tbody>
                        <tr>
                            <td><a href="/notice/view?idx=${list.notice_idx}"><c:out
                                    value="${fn:substring(list.title,0,15)}"/>
                                <c:if test="${fn:length(list.title) > 15}"> ...</c:if></a></td>
                            <td>${list.reg_date}</td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div id="Q&A" class="box">
                ...
                <c:forEach items="${qnaDTOList}" var="list">
                    ...
                    <table class="table">
                        <tbody>
                        <tr>
                            <td><a href="/qna/view?idx=${list.qna_idx}">[Q]<c:out
                                    value="${fn:substring(list.question_title,0,15)}"/>
                                <c:if test="${fn:length(list.question_title) > 15}"> ...</c:if></a></td>
            ...
            <div id="FAQ" class="box">
                ...
                <c:forEach items="${faqDTOList}" var="list">
                    ...
                    <table class="table">
                        <tbody>
                        <tr>
                            <td><a href="/faq/list">[${list.faq_title}]<c:out
                                    value="${fn:substring(list.faq_content,0,10)}"/>
